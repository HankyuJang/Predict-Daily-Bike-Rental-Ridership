...
from neural_network_2layers import *
...
test_targets = pd.read_csv("data/test_targets.csv")
...
plt.legend()
_ = plt.ylim()
plt.savefig("plots/step2_model_loss.png")

# Check out the predictions
fig, ax = plt.subplots(figsize=(8,4))

scaled_features = {}
with open('data/scaled_features.csv', 'r') as f:
    for line in f:
...
plt.savefig("plots/step3_prediction.png")
